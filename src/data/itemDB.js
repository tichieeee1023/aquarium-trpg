...
export const ITEM_DATABASE = {
  ...
  CANDY: item('candy', '멘톨 캔디', 'item_gear_candy', '섭취 시 SAN +5 회복'),
  LOTTO: item('lotto', '스피또 복권', 'item_gear_lotto_coin', '기적을 바라는 부적'),

  ENERGY: item('energy_drink', '에너지 드링크', 'item_energy_drink'),
...
export const ITEM_DB = {
  ...
  protein_bar: { id: 'protein_bar', name: '단백질 바', desc: '섭취 시 HP +5 회복', icon: '🍫' },
