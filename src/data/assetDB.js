import { JOBS, SCENARIOS, ENDINGS } from '../game/index.js';
...
export const SCENE_ASSETS = {
  ...
  BLACKOUT: { src: '/assets/scenes/scene_stage1_blackout_shock.webp', alt: '암전과 함께 검게 변한 해파리 터널' },
...
export const ENDING_CARDS = Object.fromEntries(Object.keys(ENDINGS).map((id) => [id, `/assets/endings/card_ending_${id.toLowerCase().replace('_', '')}.webp`]));
