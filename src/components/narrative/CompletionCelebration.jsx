...
const CELEBRATION_KEY = 'aquarium-completion-celebrated-v1';
...
export default function CompletionCelebration({ complete, disableEffects }) {
  ...
  return <div className="completion-celebration" role="status" aria-live="polite"><canvas className="completion-canvas" aria-hidden="true" /><p><strong>모든 기록을 수집했습니다.</strong><span>지상으로 돌아오는 순간까지 함께해 주셔서 감사합니다.</span></p></div>;
}
