...
const NOTES = [
  ...
  ['GAME STATE', '직업 · 인벤토리 · AP · HP / SAN · 플래그 기반 분기'],
  ...
  return (
    ...
    >
      ...
      <p className="credits-footnote">
        심야 아쿠아리움에서 탈출하는 분기형 생존 텍스트로그 TRPG.
      </p>

      <div className="credits-links">
        <a
          className="credits-source-link"
          href="https://github.com/tichieeee1023/aquarium-trpg#readme"
          target="_blank"
          rel="noreferrer"
          aria-label="GitHub에서 아쿠아리움 프로젝트 README 열기 (새 탭)"
        >
