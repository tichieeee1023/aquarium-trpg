...
const STAGE_HINTS = {
  STAGE_1_JELLYFISH: '물 위로 번지는 불꽃을 막을 장비를 먼저 찾으세요.',
  STAGE_2_BULKHEAD: '닫혀가는 문에는 무거운 지렛대가 필요합니다.',
  STAGE_3_FREEZER: '얼어붙은 손잡이에는 열을 남길 도구가 필요합니다.',
  STAGE_4_PUMP: '마지막 급류를 버티려면 숨을 지킬 장비를 찾으세요.',
  STAGE_5_DOME: '열과 지렛대, 그리고 한 모금의 공기가 지상으로 이어집니다.',
